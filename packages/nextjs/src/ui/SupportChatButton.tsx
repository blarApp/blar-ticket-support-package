...
export interface SupportChatButtonProps {
  // Display options
...
const DEFAULT_ARIA_LABEL = 'Open support chat';
const DEFAULT_TEXT = 'Chat Support';
...
export function SupportChatButton({
  ...
  const { openSupportChat, config } = useBlarioContext();
  ...
  if (unstyled) {
    ...
    return (
      <button
        ...
        data-tour-id="support-chat-button"
      >
